 ...
 *
 * XXX This primarily code does linear searchs through map keys because of extra logic on key
 * comparisons. Find a way to use the maps properly.
 *
 * NOTE: This is a copy of the file used in the NB V3 plugin, though it's in a different package
 * there (org.netbeans.modules.glassfish.javaee.db).
 *
...
public class DriverMaps {
    ...
    public static final String getUrlPrefix(String inClass, String resType) {
        return resType.equals("javax.sql.ConnectionPoolDataSource") ? getPrefix(cpClassMap, inClass) : getPrefix(dsClassMap, inClass);
    }
