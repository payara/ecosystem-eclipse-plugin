...
import org.eclipse.glassfish.tools.sdk.GlassFishToolsConfig;
...
public abstract class Runner implements Callable<Result> {
	...
	protected static class StateChange {
		 ...
		 *            Event related to execution state change.
		 * @param args
		 *            Additional state change request arguments.
		 */
	 ...
	 * 
	 * @param value
	 *            <code>boolean</code> value to be converted.
	 ...
	 * 
	 * @param constant
	 *            Constant representing <code>boolean</code> value.
	 * @return Original <code>boolean</code> value.
	 * @throws CommandException
	 *             when constant representing <code>boolean</code> value is not
	 *             recognized.
	 */
	 ...
	 * @param command
	 *            GlassFish Server HTTP Administration Command Entity.
	 * @param path
	 *            Server command path.
	 */
	 ...
	 * <p/>
	 * 
	 * @param silentFailureAllowed
	 *            The silentFailureAllowed to set.
	 */
	 ...
	 * 
	 * @param listeners
	 *            Listeners to notify about task state changes.
	 */
	 ...
	 *            Exception message.
	 * @param display
	 *            Display this event in GUI (Transformed to <code>String</code>
	 *            value containing <code>"true"</code> value when user should be
	 *            notified or <code>"true"</code> or <code>null</code> otherwise.
	 ...
	 * 
	 * @param executor
	 *            {@link ExecutorService} instance used to run this task.
	 * @return <code>Future</code> object to retrieve receiveResult of asynchronous
	 *         execution.
	 */
	 ...
	 *             if there is a problem with setting the headers.
	 */
	 ...
	 * 
	 * @param method
	 *            Method component of log message key.
	 */
