...
import static org.eclipse.glassfish.tools.sdk.TaskEvent.AUTH_FAILED;
import static org.eclipse.glassfish.tools.sdk.TaskEvent.BAD_GATEWAY;
import static org.eclipse.glassfish.tools.sdk.utils.ServerUtils.isAdminPortListening;
import static org.eclipse.glassfish.tools.server.ServerStatus.NOT_DEFINED;
import static org.eclipse.glassfish.tools.server.ServerStatus.RUNNING_CONNECTION_ERROR;
import static org.eclipse.glassfish.tools.server.ServerStatus.RUNNING_CREDENTIAL_PROBLEM;
import static org.eclipse.glassfish.tools.server.ServerStatus.RUNNING_DOMAIN_MATCHING;
import static org.eclipse.glassfish.tools.server.ServerStatus.RUNNING_PROXY_ERROR;
import static org.eclipse.glassfish.tools.server.ServerStatus.RUNNING_REMOTE_NOT_SECURE;
...
public class ServerStatusHelper {
	...
	/**
	 * This listener stores the last task event that occurred during command
	 * execution. It's return value is well defined only after corresponding
	 * Future.get method returned. It can also return null if no event was observed
	 * or execution timed out. Do not put the same instance into two exec calls that
	 * run concurrently, it is not thread safe.
	 * 
