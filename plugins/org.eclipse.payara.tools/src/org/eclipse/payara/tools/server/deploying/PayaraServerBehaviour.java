...
import static org.eclipse.payara.tools.sapphire.IPayaraServerModel.PROP_ENABLE_HOT_DEPLOY_DEFAULT;
	...
	private void publishDeployedDirectory(int kind, int deltaKind, Properties publishProperties, IModule module[],
		...
		if (deltaKind == REMOVED) {
			...
			if (needARedeploy) {
				...
				boolean hotDeploy = getServer().getAttribute(PROP_ENABLE_HOT_DEPLOY.name(),
						Boolean.parseBoolean(PROP_ENABLE_HOT_DEPLOY_DEFAULT));
