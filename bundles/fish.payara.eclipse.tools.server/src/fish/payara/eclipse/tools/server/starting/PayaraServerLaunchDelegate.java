...
package fish.payara.eclipse.tools.server.starting;

import static fish.payara.eclipse.tools.server.Messages.abortLaunchMsg;
import static fish.payara.eclipse.tools.server.Messages.badGateway;
import static fish.payara.eclipse.tools.server.Messages.canntCommunicate;
import static fish.payara.eclipse.tools.server.Messages.checkVpnOrProxy;
import static fish.payara.eclipse.tools.server.Messages.domainNotMatch;
import static fish.payara.eclipse.tools.server.Messages.wrongUsernamePassword;
...
import static fish.payara.eclipse.tools.server.sdk.server.ServerTasks.getDebugPort;
import static fish.payara.eclipse.tools.server.sdk.server.ServerTasks.StartMode.DEBUG;
import static fish.payara.eclipse.tools.server.sdk.server.ServerTasks.StartMode.START;
...
import fish.payara.eclipse.tools.server.sdk.server.ServerTasks.StartMode;
