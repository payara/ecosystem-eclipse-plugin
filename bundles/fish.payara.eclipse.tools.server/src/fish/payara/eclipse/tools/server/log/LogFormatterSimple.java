...
import static fish.payara.eclipse.tools.server.log.AbstractLogFilter.GlassfishLogFields.DATETIME;
import static fish.payara.eclipse.tools.server.log.AbstractLogFilter.GlassfishLogFields.LEVEL;
import static fish.payara.eclipse.tools.server.log.AbstractLogFilter.GlassfishLogFields.MESSAGE;

import java.util.Formatter;

import fish.payara.eclipse.tools.server.log.AbstractLogFilter.GlassfishLogFields;
import fish.payara.eclipse.tools.server.log.AbstractLogFilter.ILogFormatter;
