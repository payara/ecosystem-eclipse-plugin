...
public enum ModuleType {
    ...
    /**
     * Returns a <code>ModuleType</code> with a value represented by the specified <code>String</code>.
     * The <code>ModuleType</code> returned represents existing value only if specified
