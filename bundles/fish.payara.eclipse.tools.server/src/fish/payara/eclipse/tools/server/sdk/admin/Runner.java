...
import static fish.payara.eclipse.tools.server.sdk.TaskEvent.SUBMIT;
import static fish.payara.eclipse.tools.server.sdk.TaskState.READY;
...
import fish.payara.eclipse.tools.server.sdk.GlassFishToolsConfig;
...
public abstract class Runner implements Callable<Result> {
    ...
    /**
     * Executor used to serialize administration commands passed to GlassFish server.
     */
    ...
    /**
     * Returns shared <code>Executor</code> instance to serialize administration commands passed to
     * GlassFish server.
     * <p/>
    ...
    /**
     * Create <code>Result</code> object corresponding to command execution value to be returned.
     */
     ...
     * state listeners about command execution state change.
     * <p/>
     * This method is not responsible for setting receiveResult value returned by GlassFish. This method
    ...
    /**
     * Used with external execution code to prepare initial task state before task is passed to
     * executor.
     */
    ...
    /**
     * Creates {@link URLConnection} instance that represents a connection to GlassFish server
